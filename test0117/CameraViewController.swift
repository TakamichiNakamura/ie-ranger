...
//        print("path->",path)
//        print("self.madepath->",self.madePath)
//        print("madepath->",madePath)
...
//            self.presentViewController(nextView, animated: true, completion: nil)
    ...
    override func viewDidDisappear(animated: Bool) {
        ...
        self.avDevice = nil
        self.avSession = nil
        let testPath:String = NSSearchPathForDirectoriesInDomains(NSSearchPathDirectory.DocumentDirectory, NSSearchPathDomainMask.UserDomainMask, true)[0]
        print("pathのやつを改めてチェック",testPath)
    }
